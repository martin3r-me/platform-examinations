    ...
    public function getSchema(): array
    {
        return $this->mergeWriteSchema([
            'properties' => [
                ...
                'combination_group' => ['type' => 'string', 'description' => 'Optional: Vermengungsgruppe (orthogonal zur category), z.B. "vorsorge" | "eignung". Nur EINE Gruppe je Termin erlaubt.'],
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        try {
            ...
            $examination = (new ExaminationService())->create([
                ...
                'combination_group'  => $val('combination_group'),
